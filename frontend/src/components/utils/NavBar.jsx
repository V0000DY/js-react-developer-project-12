      ...
      <Container>
        ...
        <Stack direction="horizontal" gap={3}>
          ...
          <Dropdown className="d-flex">
            <Dropdown.Toggle split variant="link" id="dropdown-split-secondary" className="flex-grow-0 rounded-0">
            ...
            <Dropdown.Menu>
              <Dropdown.Item data-lang="ru" onClick={handleLangSwitch}>{t('navBarComp.toggleRuLang')}</Dropdown.Item>
              <Dropdown.Item data-lang="en" onClick={handleLangSwitch}>{t('navBarComp.toggleEnLang')}</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </Stack>
      </Container>
